...
public class NumMismatchesFractionBinFilter implements Filter {
    ...
    public String getSQLFilter(Set<String> availableColumns, Set<String> availableTables) {
        if(availableTables.contains("es.upc.dmag.dispatcher.NumMismatchesFractionBin")) {
            return "AUsMain.id == es.upc.dmag.dispatcher.NumMismatchesFractionBin.au_id AND " + generateRangeIntersect(
                    Double.toString(min),
                    Double.toString(max),
                    "es.upc.dmag.dispatcher.NumMismatchesFractionBin.NumMismatchesFractionBin_min",
                    "es.upc.dmag.dispatcher.NumMismatchesFractionBin.NumMismatchesFractionBin_max"
            );
        } else {
            return "";
        }
    ...
    public String getExtraTable() {
        return "es.upc.dmag.dispatcher.NumMismatchesFractionBin";
    }
}
