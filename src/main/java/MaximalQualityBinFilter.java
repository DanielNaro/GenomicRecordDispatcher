...
public class MaximalQualityBinFilter implements Filter {
    ...
    public String getSQLFilter(Set<String> availableColumns, Set<String> availableTables) {
        if(availableTables.contains("MaximalQualityBin")) {
            return "AUsMain.id == MaximalQualityBin.au_id AND " + generateRangeIntersect(
                    Double.toString(min),
                    Double.toString(max),
                    "MaximalQualityBin.MaximalQualityBin_min",
                    "MaximalQualityBin.MaximalQualityBin_max"
            );
        }else{
            return "";
        }
