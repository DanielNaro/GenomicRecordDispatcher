...
public class DeletionsLengthBinFilter implements Filter {
    ...
    public String getSQLFilter(Set<String> availableColumns, Set<String> availableTables) {
        if(availableTables.contains("DeletionsLengthBin")) {
            return "AUsMain.id == DeletionsLengthBin.au_id AND " + generateRangeIntersect(
                    Integer.toString(min),
                    Integer.toString(max),
                    "DeletionsLengthBin.DeletionsLengthBin_min",
                    "DeletionsLengthBin.DeletionsLengthBin_max"
            );
        } else return "";
    }
