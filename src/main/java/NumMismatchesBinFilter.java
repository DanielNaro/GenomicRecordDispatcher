...
public class NumMismatchesBinFilter  implements Filter {
    ...
    public String getSQLFilter(Set<String> availableColumns, Set<String> availableTables) {
        if(availableColumns.contains("NumMismatchesBin")) {
            return "AUsMain.id == NumMismatchesBin.au_id AND " + generateRangeIntersect(
                    Double.toString(min),
                    Double.toString(max),
                    "NumMismatchesBin.NumMismatchesBin_min",
                    "NumMismatchesBin.NumMismatchesBin_max"
            );
        } else {
            return "";
        }
